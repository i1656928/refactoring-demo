...
public class CustomerTest {
    ...
    @Test
    public void itShouldMovieInfoWhenAddRental(){
        String sutName = "Dummy customer";
        Customer sut = new Customer(sutName);
        ...
        Assert.assertTrue("Amount owed need not to be 0", !statement.contains("Amount owed is 0"));
        Assert.assertTrue("Amount owed need to be in statement", statement.contains("Amount owed is"));
